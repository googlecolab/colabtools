...
def _convert_to_interactive(key):
  ...
  if key in _last_noninteractive_df:
    return data_table.DataTable(_last_noninteractive_df.pop(key))
  elif key in _noninteractive_df_refs:
    return data_table.DataTable(_noninteractive_df_refs.pop(key))
  print(
...
def _get_html(dataframe, key):
  ...
  """.format(
      ...
      data_table_url=data_table._DATA_TABLE_HELP_URL,
