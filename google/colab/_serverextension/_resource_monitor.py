...
def get_ram_usage(kernel_manager):
  ...
  if is_test_env:
    ...
    usage, limit = _serverextension._ram_utils.get_total_ram()  # pylint: disable=protected-access
  ...
  if is_test_env:
    ...
    kernels = _serverextension._ram_utils.get_per_kernel_ram_usage(  # pylint: disable=protected-access
        kernel_manager
    )
